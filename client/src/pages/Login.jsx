        ...
        <>
            ...
            <form onSubmit={handleSubmit} className="flex flex-col gap-6 justify-center items-center h-70">
                ...
                <div className="flex justify-center items-center">
                    <button style={{fontFamily: 'var(--font-family2, "Barlow Condensed", sans-serif)', backgroundColor: '#FFDB00'}} className="text-[19px] flex p-2 w-220 justify-center">LOGIN</button>
                </div>
            </form>
